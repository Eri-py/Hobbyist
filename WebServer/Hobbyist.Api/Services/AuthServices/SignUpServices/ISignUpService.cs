...
public interface ISignUpService
{
    ...
    /// Successful verification marks the email as confirmed in the system.
    /// </remarks>
    public Task<Result<OtpResponse>> ResendOtpAsync(ResendOtpRequestSignUp request);
    ...
    /// </remarks>
    public Task<Result<AuthResult>> CompleteSignUpAsync(CompleteRegistrationRequest request);
}
